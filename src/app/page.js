...
const faqs = [
  {
    ...
    answer: "For students looking to build a high-income career immediately after 12th, Website Development (MERN Stack), Advanced Digital Marketing, and Graphic Designing are top choices. If you prefer finance, our Tally Prime & GST course offers immediate accounting job opportunities."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, our Accounts course covers the latest Tally Prime software along with real-world taxation workflows, including how to generate E-way bills, calculate TDS, and file GST returns accurately for businesses."
  },
  {
...
const AnimatedCounter = ({ end, suffix = "", title }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4">
      <span className="text-4xl md:text-5xl font-extrabold text-[#FF7A00] drop-shadow-md">
        {count}{suffix}
      </span>
      <span className="text-blue-100 font-semibold mt-2 text-sm md:text-base uppercase tracking-wider text-center">
        {title}
      </span>
    </div>
  );
  ...
  return (
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            ...
            },
            {
              "@context": "https://schema.org",
              "@type": "ItemList",
              "itemListElement": courses.slice(0, 3).map((course, index) => ({
                "@type": "ListItem",
                "position": index + 1,
                "item": {
                  "@type": "Course",
      ...
      <main className="w-full overflow-x-hidden bg-white text-gray-800 font-sans selection:bg-[#FF7A00] selection:text-white">
        ...
        {/* ================= 1. HERO SECTION ================= */}
        <section className="relative w-full min-h-screen flex items-center justify-center bg-gray-900 pt-20">
                ...
                <SwiperSlide key={i}>
                  <div className="relative w-full h-full">
                    <Image
                      ...
                      fill
                      priority={i === 0}
                      alt={`Computer Training Institute in Ludhiana Punjab - Image ${i + 1}`}
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-[2rem] shadow-2xl max-w-5xl p-8 md:p-14 border-t-[6px] border-[#FF7A00] mt-10 md:mt-0 transition-transform duration-700 translate-y-0">
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-6">
                <span className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-blue-50 text-[#1F3E8A] font-extrabold text-xs sm:text-sm tracking-wider uppercase border border-blue-100">
                  <ShieldCheck className="w-4 h-4 text-[#FF7A00]" /> ISO 9001:2015
                </span>
                <span className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-orange-50 text-[#FF7A00] font-extrabold text-xs sm:text-sm tracking-wider uppercase border border-orange-100">
                  <Award className="w-4 h-4 text-[#1F3E8A]" /> MSME Registered
                </span>
              </div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#1F3E8A] leading-tight tracking-tight mb-6">
                ...
                <span className="text-[#FF7A00]">Career-Based Practical Training</span>
              </h1>

              <p className="mt-4 text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto font-medium">
                Transform your future with <strong className="text-[#1F3E8A]">RareTech Institute</strong>. We masterclass students in Website Development, Digital Marketing, Graphic Design, and Accounting through 100% live projects designed for immediate job placements and global freelancing.
              </p>
        ...
        <section className="relative z-30 max-w-6xl mx-auto px-4 sm:px-6 -mt-12 md:-mt-20">
        ...
        <section className="py-20 md:py-32 max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold text-[#1F3E8A] leading-tight mb-6">
                Computer Courses in Ludhiana Designed for the Modern Industry
              </h2>
              <div className="w-20 h-1.5 bg-[#FF7A00] rounded-full mb-8"></div>
              ...
              <ul className="space-y-4 font-bold text-[#1F3E8A] text-lg">
                <li className="flex items-center gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
                  <CheckCircle className="text-[#FF7A00] w-6 h-6 flex-shrink-0" /> Focus strictly on practical Live Projects
                </li>
                <li className="flex items-center gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
                  <CheckCircle className="text-[#FF7A00] w-6 h-6 flex-shrink-0" /> Global Freelancing & Client Mentorship
                </li>
                <li className="flex items-center gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
                  <CheckCircle className="text-[#FF7A00] w-6 h-6 flex-shrink-0" /> Dedicated placement assistance & resume building
                </li>
                <li className="flex items-center gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
                  <CheckCircle className="text-[#FF7A00] w-6 h-6 flex-shrink-0" /> Highly experienced industry-expert trainers
                </li>
                <li className="flex items-center gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
                  <CheckCircle className="text-[#FF7A00] w-6 h-6 flex-shrink-0" /> Affordable fee structure with easy installments
                </li>
              </ul>
            </div>
            
            <div className="w-full lg:w-1/2 relative mt-10 lg:mt-0">
              <div className="absolute -top-10 -right-10 w-72 h-72 bg-[#FF7A00] rounded-full mix-blend-multiply filter blur-3xl opacity-20 z-0"></div>
              <div className="absolute -bottom-10 -left-10 w-72 h-72 bg-[#1F3E8A] rounded-full mix-blend-multiply filter blur-3xl opacity-20 z-0"></div>
              ...
              <div className="relative z-10 aspect-square md:aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-white">
                <Image 
                  ...
                  fill 
                  alt="Students learning practically at IT Training Institute in Punjab" 
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-md shadow-xl rounded-2xl p-6 border border-gray-100">
                  <p className="text-[#1F3E8A] font-extrabold text-lg flex items-center gap-3">
                    <Trophy className="text-[#FF7A00] w-6 h-6" /> Empowering Punjab's Youth
                  </p>
        ...
        {/* ================= 4. ALL COURSES GRID ================= */}
        <section className="bg-[#1F3E8A] py-20 md:py-32 relative overflow-hidden">
                ...
                <article key={index} className="bg-white rounded-[2rem] overflow-hidden shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col h-full group border border-transparent hover:border-[#FF7A00]/30">
                  ...
                  <div className="relative h-56 w-full overflow-hidden bg-gray-100">
                    <Image
                      src={course.image}
                      fill
                      alt={`${course.title} Training in Ludhiana`}
                      className="object-cover group-hover:scale-110 transition-transform duration-700 ease-in-out"
                      sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1F3E8A]/80 to-transparent opacity-60 group-hover:opacity-80 transition-opacity duration-300"></div>
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                      ...
                      <ul className="space-y-2.5">
                        {course.benefits.map((benefit, idx) => (
                          <li key={idx} className="text-sm text-gray-700 flex items-start gap-2 font-semibold">
                            <CheckCircle className="text-[#FF7A00] w-4 h-4 flex-shrink-0 mt-0.5" />
                    ...
                    >
                      View Syllabus Details <ArrowRight className="w-5 h-5" />
                    </Link>
                  </div>
                </article>
              ))}
        ...
        <section className="py-20 md:py-32 max-w-7xl mx-auto px-6 bg-gray-50">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-extrabold text-[#1F3E8A]">
              Why Students Prefer RareTech?
            </h2>
            <p className="mt-6 text-lg text-gray-600 font-medium">
              We don't just distribute basic certificates. We actively engineer highly profitable careers. Here is what sets us apart from regular institutes.
            </p>
          </div>
        ...
        <section className="py-20 md:py-32 max-w-7xl mx-auto px-6">
          <div className="bg-white rounded-[3rem] p-8 md:p-16 shadow-2xl border border-gray-100 relative overflow-hidden">
            {/* Decoration */}
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#1F3E8A] via-[#FF7A00] to-[#1F3E8A]"></div>
            <div className="absolute top-0 right-0 w-96 h-96 bg-blue-50 rounded-full mix-blend-multiply opacity-60 -translate-y-1/2 translate-x-1/3"></div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16 relative z-10">
              ...
              <div className="w-full lg:w-1/2">
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#1F3E8A] mb-6 leading-tight">
                  Placement Assistance in <span className="text-[#FF7A00]">Ludhiana</span>
                </h2>
                ...
                <div className="grid grid-cols-2 gap-4 mb-10">
                  <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 text-center">
                    <Briefcase className="w-8 h-8 text-[#1F3E8A] mx-auto mb-3" />
                  ...
                  <div className="bg-orange-50 p-6 rounded-2xl border border-orange-100 text-center">
                    <GraduationCap className="w-8 h-8 text-[#FF7A00] mx-auto mb-3" />
                ...
                >
                  <ShieldCheck className="w-6 h-6" /> Verify Digital Certificates
                </Link>
              </div>
        ...
        <section className="bg-gray-50 py-20 md:py-32 border-y border-gray-200">
          <div className="max-w-5xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-5xl font-extrabold text-[#1F3E8A] mb-10">
        ...
        {/* ================= 8. FAQ SECTION ================= */}
        <section className="py-20 md:py-32 bg-white max-w-4xl mx-auto px-6">
        ...
        {/* ================= 9. FINAL CTA ================= */}
        <section className="bg-gradient-to-br from-[#1F3E8A] via-[#1A367A] to-[#0A1A4A] text-white py-24 md:py-32 relative overflow-hidden">
          {/* Background pattern */}
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <h2 className="text-4xl md:text-6xl font-extrabold leading-tight mb-8 drop-shadow-lg">
              Ready To Start Your <span className="text-[#FF7A00]">IT Career Journey?</span>
            </h2>
